...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_file',default='./emotionNet/checkpoints/large.json',help='path to json file')
    parser.add_argument('--model_file',default='./emotionNet/checkpoints/large.h5', help='path to pre-trained model')
    parser.add_argument('--landmark_exe_path', default='./landmarkDetector', type=str)
    parser.add_argument('--fitmodel_exe_path', default='./proxyEstimator', type=str)
    parser.add_argument('--render_exe_path', default='./textureRender', type=str)

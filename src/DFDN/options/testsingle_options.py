...
class TestSingle(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--json_file',default='./emotionNet/checkpoints/large.json',help='path to json file')
        self.parser.add_argument('--model_file',default='./emotionNet/checkpoints/large.h5', help='path to pre-trained model')
        self.parser.add_argument('--landmark_exe_path', default='./landmarkDetector', type=str)
        self.parser.add_argument('--fitmodel_exe_path', default='./proxyEstimator', type=str)
        self.parser.add_argument('--render_exe_path', default='./textureRender', type=str)
